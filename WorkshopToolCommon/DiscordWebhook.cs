...
namespace Phoenix.WorkshopTool
{
    class DiscordWebhook
    {
        ...
        static readonly Regex s_urlValidator = new Regex("https://discord.com/api/webhooks/[0-9]+/[a-zA-Z0-9-]+", RegexOptions.Compiled, new TimeSpan(0, 0, 1));
        ...
        {
            if (s_urlValidator.IsMatch(url))
            {
                string requestPayload = string.Format(s_payload, m_type, m_title.Replace("\r\n", "\\n"), m_changelog.Replace("\r\n", "\\n"));
